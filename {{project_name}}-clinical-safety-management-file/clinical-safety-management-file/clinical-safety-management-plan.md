...
This document is for the {{ clinical_safety_team_name }} staff that are involved in ensuring the safety of the RCPCH's Healthcare IT systems, products or services, but is made publicly available as part of our commitment to transparency and open governance.
...
!!! danger "IMPORTANT NOTICE FOR SELF-HOSTING"
    IMPORTANT: This Clinical Risk Management File applies ONLY to RCPCH open source software as deployed and managed by the {{ clinical_safety_team_name }} under our direct control.
...
Clinical Safety Officer Contact: {{ clinical_safety_officer_contact }}
